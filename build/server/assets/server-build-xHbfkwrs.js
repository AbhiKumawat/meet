...
const Earth = lazy(() => import("./earth-DdMwYLGP.js").then((module) => ({ default: module.Earth })));
const EarthSection = lazy(
  () => import("./earth-DdMwYLGP.js").then((module) => ({ default: module.EarthSection }))
);
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-D3cfhGg3.js").then((module) => ({ default: module.DisplacementSphere }))
);
...
const Model = lazy(
  () => import("./index-CXOhwUha.js").then((module) => ({ default: module.Model }))
);
